// --------------------------------------------------------------------------------------------------------------------
// <copyright file="PublicationTestFixture.cs" company="RHEA System">
//
...
namespace WebservicesIntegrationTests
{
    ...
    [TestFixture]
    public class PublicationTestFixture : WebClientTestFixtureBase
    {
        ...
        /// <summary>
        /// Verification that the Publication objects are returned from the data-source and that the 
        /// values of the Publication properties are equal to the expected value
        /// </summary>
        [Test]
