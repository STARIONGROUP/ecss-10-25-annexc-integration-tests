// --------------------------------------------------------------------------------------------------------------------
// <copyright file="CommonFileStoreFileTestFixture.cs" company="Starion Group S.A.">
//
...
namespace WebservicesIntegrationTests
{
    ...
    [TestFixture]
    public class CommonFileStoreFileTestFixture : WebClientTestFixtureBaseWithDatabaseRestore
    {
        [Test]
        [Category("GET")]
        public void VerifyThatExpectedFileIsReturnedFromWebApi()
        {
            ...
            var fileUri = new Uri($"{this.Settings.Hostname}/EngineeringModel/9ec982e4-ef72-4953-aa85-b158a95d8d56/commonFileStore/8e5ca9cc-3da8-4e66-9172-7c3b2464a59c/file");
            ...
            var file =
                jArray.Single(x => (string) x[PropertyNames.Iid] == "95bf0f17-1273-4338-98ae-839016242776");
        ...
        {
            // define the URI on which to perform a GET request
            var fileUri = new Uri($"{this.Settings.Hostname}/EngineeringModel/9ec982e4-ef72-4953-aa85-b158a95d8d56/commonFileStore/8e5ca9cc-3da8-4e66-9172-7c3b2464a59c/file?includeAllContainers=true");
            ...
            var commonFileStore = jArray.Single(x => (string) x[PropertyNames.Iid] == "8e5ca9cc-3da8-4e66-9172-7c3b2464a59c");

            CommonFileStoreTestFixture.VerifyProperties(commonFileStore);

            // get a specific File from the result by it's unique id
            var file = jArray.Single(x => (string) x[PropertyNames.Iid] == "95bf0f17-1273-4338-98ae-839016242776");
        ...
        public void VerifyThatFileAndSubsequentRevisionCannotBeUploadedWithWebApiWhenParticipantIsNotAnOwner()
        {
            ...
            var postJsonPath = this.GetPath("Tests/EngineeringModel/CommonFileStoreFile/PostNewFile.json");
            var postFilePath = this.GetPath("Tests/EngineeringModel/CommonFileStoreFile/2990BA2444A937A28E7B1E2465FCDF949B8F5368");
        ...
        public async Task VerifyThatFileAndSubsequentRevisionCanBeDeletedByOwner()
        {
            ...
            var possibleFiles = commonFileStore[PropertyNames.File].Select(x => (string)x).ToList();
            var expectedFiles = new[] { "95bf0f17-1273-4338-98ae-839016242776" };

            Assert.That(possibleFiles, Is.EquivalentTo(expectedFiles));
        }
        ...
        public async Task VerifyThatFileAndSubsequentRevisionCanBeUploadedWithWebApi()
        {
            ...
            Assert.That((int)commonFileStore[PropertyNames.RevisionNumber], Is.EqualTo(2));
            ...
            var fileRevision = jArray.Single(x => (string)x[PropertyNames.Iid] == "76e9b7fc-edc4-4ca3-89ba-eac014e7d9f8");
            ...
            // Subsequent revision
            var fileUri = new Uri($"{this.Settings.Hostname}/EngineeringModel/9ec982e4-ef72-4953-aa85-b158a95d8d56/iteration/e163c5ad-f32b-4387-b805-f4b34600bc2c");
            postJsonPath = this.GetPath("Tests/EngineeringModel/CommonFileStoreFile/PostNewFileRevision.json");
            postFilePath = this.GetPath("Tests/EngineeringModel/CommonFileStoreFile/1525ED651E5B609DAE099DEEDA8DBDB49CFF956F");
        ...
        public void VerifyThatFileCannotBeUploadedWhenParticipantIsNotOwner()
        {
            ...
            // Subsequent revision
            var fileUri = new Uri($"{this.Settings.Hostname}/EngineeringModel/9ec982e4-ef72-4953-aa85-b158a95d8d56/iteration/e163c5ad-f32b-4387-b805-f4b34600bc2c/file/95bf0f17-1273-4338-98ae-839016242776");
            var postJsonPath = this.GetPath("Tests/EngineeringModel/CommonFileStoreFile/PostNewFile.json");
            var postFilePath = this.GetPath("Tests/EngineeringModel/CommonFileStoreFile/2990BA2444A937A28E7B1E2465FCDF949B8F5368");
        ...
        public async Task VerifyThatAFileRevisionCanBeDownloadedWithWebApi()
        {
            ...
            postJsonPath = this.GetPath("Tests/EngineeringModel/CommonFileStoreFile/PostNewFileBinaryRevision.json");
            postFilePath = this.GetPath("Tests/EngineeringModel/CommonFileStoreFile/3F64667F0F27A4C4FA1B4BF374033938A542FDD1");
            await this.WebClient.PostFile(fileUri2, postJsonPath, postFilePath);

            // Download a revision of the plain text file
            var getFileUriForTxt = new Uri($"{this.Settings.Hostname}/EngineeringModel/9ec982e4-ef72-4953-aa85-b158a95d8d56/commonFileStore/8e5ca9cc-3da8-4e66-9172-7c3b2464a59c/file/8ac6db3e-9525-4f3e-93ea-707076c07fc1/fileRevision/76e9b7fc-edc4-4ca3-89ba-eac014e7d9f8?includeFileData=true");
            var responseBodyForTxt = await this.WebClient.GetFileResponseBody(getFileUriForTxt);

            // Download a revision of the pdf file
            var getFileUriForPdf = new Uri($"{this.Settings.Hostname}/EngineeringModel/9ec982e4-ef72-4953-aa85-b158a95d8d56/commonFileStore/8e5ca9cc-3da8-4e66-9172-7c3b2464a59c/file/8ac6db3e-9525-4f3e-93ea-707076c07fc1/fileRevision/e5b46d1b-7d51-4433-b515-25d7d37a0b50?includeFileData=true");
        ...
        {
            var iterationUri = new Uri($"{this.Settings.Hostname}/EngineeringModel/9ec982e4-ef72-4953-aa85-b158a95d8d56/iteration/e163c5ad-f32b-4387-b805-f4b34600bc2c");
            var postJsonPath = this.GetPath("Tests/EngineeringModel/CommonFileStoreFile/PostNewFolderWithFile.json");
            var postFilePath = this.GetPath("Tests/EngineeringModel/CommonFileStoreFile/2990BA2444A937A28E7B1E2465FCDF949B8F5368");
            await this.WebClient.PostFile(iterationUri, postJsonPath, postFilePath);

            // Download a zip archive of the folder
            var getFileUri = new Uri($"{this.Settings.Hostname}/EngineeringModel/9ec982e4-ef72-4953-aa85-b158a95d8d56/commonFileStore/8e5ca9cc-3da8-4e66-9172-7c3b2464a59c/folder/e80daca0-5c6e-4236-ae34-d23c36244059?includeFileData=true");
        ...
        public async Task VerifyThatAFileStoreCanBeDownloadedWithWebApi()
        {
            ...
            // Download a zip archive of the folder
            var getFileUri = new Uri($"{this.Settings.Hostname}/EngineeringModel/9ec982e4-ef72-4953-aa85-b158a95d8d56/commonFileStore/8e5ca9cc-3da8-4e66-9172-7c3b2464a59c?includeFileData=true");
            var responseBody = await this.WebClient.GetFileResponseBody(getFileUri);
        ...
        public static void VerifyProperties(JToken file)
        {
            ...
            Assert.That((string)file[PropertyNames.Iid], Is.EqualTo("95bf0f17-1273-4338-98ae-839016242776"));
            ...
            var expectedFileRevisions = new string[]
            {
                "5544bb87-dc38-45d5-9d92-c580d3fe0443"
            };
