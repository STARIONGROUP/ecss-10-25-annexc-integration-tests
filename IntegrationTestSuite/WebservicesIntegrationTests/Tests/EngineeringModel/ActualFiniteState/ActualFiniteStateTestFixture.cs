// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ActualFiniteStateTestFixture.cs" company="RHEA System">
//
...
namespace WebservicesIntegrationTests
{
    ...
    {
        /// <summary>
        /// Verification that the ActualFiniteState objects are returned from the data-source and that the 
        /// values of the ActualFiniteState properties are equal to the expected value
        /// </summary>
        [Test]
