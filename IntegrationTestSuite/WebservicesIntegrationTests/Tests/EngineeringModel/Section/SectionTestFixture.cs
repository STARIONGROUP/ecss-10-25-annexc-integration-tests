// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SectionTestFixture.cs" company="RHEA System">
//
...
namespace WebservicesIntegrationTests
{
    ...
    /// <summary>
    /// Suite of tests for the Section ClassKind
    /// </summary>
    [TestFixture]
    public class SectionTestFixture : WebClientTestFixtureBaseWithDatabaseRestore
    {
        ...
        public void VerifyThatSectionCanBeAddedAndDeleted()
        {
            ...
            var jArray = this.WebClient.PostDto(sectionUri, postBody);
            ...
            jArray = this.WebClient.PostDto(sectionUri, postBody);
