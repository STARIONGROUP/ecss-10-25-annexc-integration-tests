...
namespace WebservicesIntegrationTests
{
    ...
    public class RequirementsSpecificationTestFixture : WebClientTestFixtureBase
    {
        ...
        public void VerifyThatExpectedRequirementsSpecificationIsReturnedFromWebApi()
        {
            ...
            var requirementsSpecificationUri =
        ...
        public void VerifyThatARequirementsSpecificationCanBeCreatedWithWebApi()
        {
            ...
            var postBodyPath =
                this.GetPath("Tests/EngineeringModel/RequirementsSpecification/PostNewRequirementsSpecification.json");
            ...
            var requirementsSpecification =
                jArray.Single(x => (string) x[PropertyNames.Iid] == "272e59f8-267a-4e5f-84eb-6d1b495bf4c7");

            // verify the amount of returned properties 
            Assert.AreEqual(12, requirementsSpecification.Children().Count());

            // assert that the properties are what is expected
            Assert.AreEqual("272e59f8-267a-4e5f-84eb-6d1b495bf4c7",
            ...
            Assert.AreEqual("TestRequirementsSpecification3",
        ...
        public static void VerifyProperties(JToken requirementsSpecification)
        {
            ...
            // assert that the properties are what is expected
            Assert.AreEqual("bf0cde90-9086-43d5-bcff-32a2f8331800",
                (string) requirementsSpecification[PropertyNames.Iid]);
