// --------------------------------------------------------------------------------------------------------------------
// <copyright file="OrExpressionTestFixture.cs" company="RHEA System">
//
...
namespace WebservicesIntegrationTests
{
    ...
    {
        /// <summary>
        /// Verification that the OrExpression objects are returned from the data-source and that the 
        /// values of the OrExpression properties are equal to the expected value
        /// </summary>
        [Test]
