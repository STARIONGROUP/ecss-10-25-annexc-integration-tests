// --------------------------------------------------------------------------------------------------------------------
// <copyright file="RelationalExpressionTestFixture.cs" company="RHEA System">
//
...
namespace WebservicesIntegrationTests
{
    ...
    {
        /// <summary>
        /// Verification that the RelationalExpression objects are returned from the data-source and that the 
        /// values of the RelationalExpression properties are equal to the expected value
        /// </summary>
        [Test]
