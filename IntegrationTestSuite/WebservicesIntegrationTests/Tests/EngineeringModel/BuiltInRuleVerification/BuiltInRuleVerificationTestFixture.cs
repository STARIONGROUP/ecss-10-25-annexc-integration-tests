// --------------------------------------------------------------------------------------------------------------------
// <copyright file="BuiltInRuleVerificationTestFixture.cs" company="RHEA System">
//
...
namespace WebservicesIntegrationTests
{
    ...
    {
        /// <summary>
        /// Verification that the BuiltInRuleVerification objects are returned from the data-source and that the 
        /// values of the BuiltInRuleVerification properties are equal to the expected value
        /// </summary>
        [Test]
