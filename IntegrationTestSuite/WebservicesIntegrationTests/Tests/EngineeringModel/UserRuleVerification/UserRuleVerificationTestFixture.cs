// --------------------------------------------------------------------------------------------------------------------
// <copyright file="UserRuleVerificationTestFixture.cs" company="RHEA System">
//
...
namespace WebservicesIntegrationTests
{
    ...
    {
        /// <summary>
        /// Verification that the UserRuleVerification objects are returned from the data-source and that the 
        /// values of the UserRuleVerification properties are equal to the expected value
        /// </summary>
        [Test]
