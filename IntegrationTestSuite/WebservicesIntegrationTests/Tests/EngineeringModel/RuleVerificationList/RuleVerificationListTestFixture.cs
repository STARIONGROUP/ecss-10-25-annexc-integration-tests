// --------------------------------------------------------------------------------------------------------------------
// <copyright file="RuleVerificationListTestFixture.cs" company="RHEA System">
//
...
namespace WebservicesIntegrationTests
{
    ...
    {
        /// <summary>
        /// Verification that the RuleVerificationList objects are returned from the data-source and that the 
        /// values of the RuleVerificationList properties are equal to the expected value
        /// </summary>
        [Test]
