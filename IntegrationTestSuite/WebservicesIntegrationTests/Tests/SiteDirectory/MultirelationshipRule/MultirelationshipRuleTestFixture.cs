// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MultirelationshipRuleTestFixture.cs" company="Starion Group S.A.">
//
...
namespace WebservicesIntegrationTests
{
    ...
    public class MultirelationshipRuleTestFixture : WebClientTestFixtureBase
    {
        ...
        public void VerifyThatExpectedRuleIsReturnedFromWebApi()
        {
            ...
            var multirelationshipRuleRuleUri = new Uri($"{this.Settings.Hostname}/SiteDirectory/f13de6f8-b03a-46e7-a492-53b2f260f294/siteReferenceDataLibrary/c454c687-ba3e-44c4-86bc-44544b2c7880/rule/2615f9ec-30a4-4c0e-a9d3-1d067959c248");
            ...
            var multirelationshipRule = jArray.Single(x => (string) x["iid"] == "2615f9ec-30a4-4c0e-a9d3-1d067959c248");
        ...
        {
            // define the URI on which to perform a GET request
            var multirelationshipRuleUri = new Uri($"{this.Settings.Hostname}/SiteDirectory/f13de6f8-b03a-46e7-a492-53b2f260f294/siteReferenceDataLibrary/c454c687-ba3e-44c4-86bc-44544b2c7880/rule/2615f9ec-30a4-4c0e-a9d3-1d067959c248?includeAllContainers=true");
