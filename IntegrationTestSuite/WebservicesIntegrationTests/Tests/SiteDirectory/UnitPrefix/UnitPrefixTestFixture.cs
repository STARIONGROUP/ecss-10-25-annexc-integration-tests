// --------------------------------------------------------------------------------------------------------------------
// <copyright file="UnitPrefixTestFixture.cs" company="RHEA System">
//
...
namespace WebservicesIntegrationTests
{
    ...
    {
        /// <summary>
        /// Verification that the UnitPrefix objects are returned from the data-source and that the 
        /// values of the UnitPrefix properties are equal to the expected value
        /// </summary>
        [Test]
