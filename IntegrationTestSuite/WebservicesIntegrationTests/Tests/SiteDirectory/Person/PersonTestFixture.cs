...
namespace WebservicesIntegrationTests
{
    ...
    public class PersonTestFixture : WebClientTestFixtureBaseWithDatabaseRestore
    {
        ...
        //Uncomment to create large model. 
        //[Test]
        //[Category("POST")]
        public void Verify_That_BulkCreation_Works()
        {
            ...
            var numberOfPersonsToCreate = 1000;
...
{{
    ...
    ""userPreference"": []
            ...
            Assert.AreEqual(guidArray.Length + 1, jArray.Count);
    ...
    {{
      ...
      ""iid"": ""{participantGuid}""
            ...
            Assert.AreEqual(guidArray.Length + 2, jArray.Count);
