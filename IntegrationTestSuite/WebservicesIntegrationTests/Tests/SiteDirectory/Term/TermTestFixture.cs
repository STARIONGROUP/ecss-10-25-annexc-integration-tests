// --------------------------------------------------------------------------------------------------------------------
// <copyright file="TermTestFixture.cs" company="RHEA System">
//
...
namespace WebservicesIntegrationTests
{
    ...
    {
        /// <summary>
        /// Verification that the Term objects are returned from the data-source and that the 
        /// values of the Term properties are equal to the expected value
        /// </summary>
        [Test]
