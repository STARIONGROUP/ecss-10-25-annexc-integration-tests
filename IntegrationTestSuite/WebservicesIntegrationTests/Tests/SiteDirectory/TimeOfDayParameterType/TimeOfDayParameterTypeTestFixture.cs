// --------------------------------------------------------------------------------------------------------------------
// <copyright file="TimeOfDayParameterTypeTestFixture.cs" company="RHEA System">
//
...
namespace WebservicesIntegrationTests
{
    ...
    {
        /// <summary>
        /// Verification that the TimeOfDayParameterType objects are returned from the data-source and that the 
        /// values of the TimeOfDayParameterType properties are equal to the expected value
        /// </summary>
        [Test]
