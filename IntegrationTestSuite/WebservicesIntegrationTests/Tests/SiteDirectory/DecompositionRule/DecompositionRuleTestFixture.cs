...
namespace WebservicesIntegrationTests
{
    ...
    public class DecompositionRuleTestFixture : WebClientTestFixtureBase
    {
        ...
        public void VerifyThatADecompositionRuleCanBeCreatedWithWebApi()
        {
            ...
            CollectionAssert.AreEquivalent(expectedRuleAliases, ruleAliases);
            ...
            CollectionAssert.AreEquivalent(expectedRuleDefinitions, ruleDefinitions);
            ...
            CollectionAssert.AreEquivalent(expectedRuleHyperlinks, hyperLinks);
        }
