// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SiteLogEntryTestFixture.cs" company="RHEA System">
//
...
namespace WebservicesIntegrationTests
{
    ...
    {
        /// <summary>
        /// Verification that the SiteLogEntry objects are returned from the data-source and that the 
        /// values of the SiteLogEntry properties are equal to to expected value.
        /// </summary>
        [Test]
