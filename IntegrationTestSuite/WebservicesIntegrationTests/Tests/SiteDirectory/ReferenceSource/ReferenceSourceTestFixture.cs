...
namespace WebservicesIntegrationTests
{
    ...
    [TestFixture]
    public class ReferenceSourceTestFixture : WebClientTestFixtureBaseWithDatabaseRestore
    {
        [Test]
        [Category("GET")]
        ...
        public void VerifyThatAReferenceSourceCanBeCreatedWithWebApi()
        {
            ...
            var expectedReferenceSources = new string[]
            {
                ...
                "b46088aa-14dd-4fbc-9f45-c4acdaf6e9f5"
            };
            ...
            // verify the amount of returned properties 
            Assert.AreEqual(18, referenceSource.Children().Count());
