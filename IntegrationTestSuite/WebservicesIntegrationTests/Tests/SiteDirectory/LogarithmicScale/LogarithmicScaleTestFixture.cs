// --------------------------------------------------------------------------------------------------------------------
// <copyright file="LogarithmicScaleTestFixture.cs" company="RHEA System">
//
...
namespace WebservicesIntegrationTests
{
    ...
    {
        /// <summary>
        /// Verification that the LogarithmicScale objects are returned from the data-source and that the 
        /// values of the LogarithmicScale properties are equal to the expected value
        /// </summary>
        [Test]
