// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ParticipantRoleTestFixture.cs" company="RHEA System">
//
...
namespace WebservicesIntegrationTests
{
    ...
    {
        /// <summary>
        /// Verification that the ParticipantRole objects are returned from the data-source and that the 
        /// values of the ParticipantRole properties are equal to the expected value
        /// </summary>
        [Test]
