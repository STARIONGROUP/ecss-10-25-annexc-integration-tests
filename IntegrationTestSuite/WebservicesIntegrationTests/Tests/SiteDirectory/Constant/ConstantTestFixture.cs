...
namespace WebservicesIntegrationTests
{
    ...
    public class ConstantTestFixture : WebClientTestFixtureBaseWithDatabaseRestore
    {
        ...
        public void VerifyThatAConstantCanBeCreatedWithWebApi()
        {
            ...
            Assert.That(constantAliases, Is.EquivalentTo(expectedConstantAliases));
            ...
            Assert.That(constantDefinitions, Is.EquivalentTo(expectedConstantDefinitions));
            ...
            Assert.That(hyperLinks, Is.EquivalentTo(expectedConstantHyperlinks));
        }
