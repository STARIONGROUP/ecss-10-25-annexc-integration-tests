// --------------------------------------------------------------------------------------------------------------------
// <copyright file="IntervalScaleTestFixture.cs" company="RHEA System">
//
...
namespace WebservicesIntegrationTests
{
    ...
    {
        /// <summary>
        /// Verification that the IntervalScale objects are returned from the data-source and that the 
        /// values of the IntervalScale properties are equal to the expected value
        /// </summary>
        [Test]
