// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ReferencerRuleTestFixture.cs" company="RHEA System">
//
...
namespace WebservicesIntegrationTests
{
    ...
    {
        /// <summary>
        /// Verification that the ReferencerRule objects are returned from the data-source and that the 
        /// values of the ReferencerRule properties are equal to the expected value
        /// </summary>
        [Test]
