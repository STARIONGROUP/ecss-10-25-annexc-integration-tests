// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DerivedUnitTestFixture.cs" company="RHEA System">
//
...
namespace WebservicesIntegrationTests
{
    ...
    {
        /// <summary>
        /// Verification that the DerivedUnit objects are returned from the data-source and that the 
        /// values of the DerivedUnit properties are equal to the expected value
        /// </summary>
        [Test]
