// --------------------------------------------------------------------------------------------------------------------
// <copyright file="CyclicRatioScaleTestFixture.cs" company="RHEA System S.A.">
//
...
namespace WebservicesIntegrationTests
{
    ...
    public class CyclicRatioScaleTestFixture : WebClientTestFixtureBaseWithDatabaseRestore
    {
        ...
        public void VerifyThatACyclicRatioScaleCanBeCreatedWithWebApi()
        {
            ...
            CollectionAssert.AreEquivalent(expectedScaleAliases, scaleAliases);
            ...
            CollectionAssert.AreEquivalent(expectedScaleDefinitions, scaleDefinitions);
            ...
            CollectionAssert.AreEquivalent(expectedScaleHyperlinks, hyperLinks);
        }
