// --------------------------------------------------------------------------------------------------------------------
// <copyright file="RatioScaleTestFixture.cs" company="RHEA System">
//
...
namespace WebservicesIntegrationTests.Tests.SiteDirectory.RatioScale
{
    ...
    {
        /// <summary>
        /// Verification that the RatioScale objects are returned from the data-source and that the 
        /// values of the RatioScale properties are equal to the expected value
        /// </summary>
        [Test]
