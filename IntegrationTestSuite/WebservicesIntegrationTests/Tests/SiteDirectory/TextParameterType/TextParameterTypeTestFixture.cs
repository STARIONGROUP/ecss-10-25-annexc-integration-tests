// --------------------------------------------------------------------------------------------------------------------
// <copyright file="TextParameterTypeTestFixture.cs" company="RHEA System">
//
...
namespace WebservicesIntegrationTests
{
    ...
    {
        /// <summary>
        /// Verification that the TextParameterType objects are returned from the data-source and that the 
        /// values of the TextParameterType properties are equal to the expected value
        /// </summary>
        [Test]
