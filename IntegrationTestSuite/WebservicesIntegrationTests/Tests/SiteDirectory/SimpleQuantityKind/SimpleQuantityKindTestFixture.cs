// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SimpleQuantityKindTestFixture.cs" company="RHEA System">
//
...
namespace WebservicesIntegrationTests
{
    ...
    {
        /// <summary>
        /// Verification that the SimpleQuantityKind objects are returned from the data-source and that the 
        /// values of the SimpleQuantityKind properties are equal to the expected value
        /// </summary>
        [Test]
