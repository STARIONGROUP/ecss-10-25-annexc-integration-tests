// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DateParameterTypeTestFixture.cs" company="RHEA System">
//
...
namespace WebservicesIntegrationTests
{
    ...
    {
        /// <summary>
        /// Verification that the DateParameterType objects are returned from the data-source and that the 
        /// values of the DateParameterType properties are equal to the expected value
        /// </summary>
        [Test]
        public void VerifyThatExpectedParameterTypeIsReturnedFromWebApi()
        {
            // define the URI on which to perform a GET request 
            var dateParameterTypeUri =
                new Uri(string.Format(UriFormat, this.Settings.Hostname,
                    "/SiteDirectory/f13de6f8-b03a-46e7-a492-53b2f260f294/siteReferenceDataLibrary/c454c687-ba3e-44c4-86bc-44544b2c7880/parameterType/33cf1171-3cd2-4494-8d54-639bfc583155"));
            ...
            var dateParameterType =
                jArray.Single(x => (string) x[PropertyNames.Iid] == "33cf1171-3cd2-4494-8d54-639bfc583155");
        ...
        public void VerifyThatExpectedParameterTypeWithContainerIsReturnedFromWebApi()
        {
            ...
            var dateParameterTypeUri =
                new Uri(string.Format(UriFormat, this.Settings.Hostname,
                    "/SiteDirectory/f13de6f8-b03a-46e7-a492-53b2f260f294/siteReferenceDataLibrary/c454c687-ba3e-44c4-86bc-44544b2c7880/parameterType/33cf1171-3cd2-4494-8d54-639bfc583155?includeAllContainers=true"));
